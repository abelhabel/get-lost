...
go.sockets = [];
go.projectiles = {};
go.workspace = new Workspace(100000, 100000, gridSize, gridSize),
...
go.camera = new Camera(50000, 50000, gridSize, gridSize),
go.gridSize = {posx: gridSize, posy: gridSize}

go.camera.setBoundingBox();
...
function populateWorld() {
  ...
  var boss = Bosses.glowFace(50000, 47000);
  boss.forEach(function(obj){
    go.workspace.addToGrid(obj);
  });

  boss = Bosses.spherlo(53000, 50000);
  boss.forEach(function(obj){
    go.workspace.addToGrid(obj);
  });
